...
ActiveRecord::Schema.define(version: 20180907095328) do
  ...
  create_table "surveys", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["house_id"], name: "index_surveys_on_house_id"
    t.index ["user_id"], name: "index_surveys_on_user_id"
    t.index ["value"], name: "index_surveys_on_value"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "false_request", default: 0
    t.integer "false_response", default: 0
